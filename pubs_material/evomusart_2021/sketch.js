...
function setup(){
  ...
  for (let i = 0; i < 6; i++) {
    ...
    text(`${45 + 5 * i}`, param.p1999.x - param.p1999.ppb - 45, param.p1999.y + param.p1999.ppp - param.p1999.ppp * 5 * (i) + 8);
    ...
    text(`${45 + 5 * i}`, param.p2322.x - param.p2322.ppb - 45, param.p2322.y + param.p2322.ppp - param.p2322.ppp * 5 * (i) + 8);
  }
  for (let i = 0; i < 7; i++) {
