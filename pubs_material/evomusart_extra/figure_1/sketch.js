...
let matched_entries = "[\n" +
    "\t[+7+2-3.0, ([0, 54], [1, 61], [4, 63]), ([0, 53], [1, 60], [4, 62])],\n" +
    "\t[+7+7-3.0, ([0, 54], [1, 61], [4, 68]), ([0, 53], [1, 60], [4, 67])],\n" +
    "\t[+3+11+1.2, ([0, 54], [1.5, 57], [2.75, 68]), ([0, 53], [2.75, 56], [5, 67])]\n" +
    "\t...\n" +
    "\t[-5-2+1.0, ([4, 68], [5, 63], [6, 61]), ([4, 74], [5, 69], [6, 67])],\n" +
    "\t[-5+7+1.0, ([4, 68], [5, 63], [6, 70]), ([4, 67], [5, 62], [6, 69])],\n" +
    "\t[-5+7+1.0, ([4, 68], [5, 63], [6, 70]), ([4, 62], [5, 57], [6, 64])]\n" +
    "]"
let p2322_entries = "[\n" +
    "\t[+7+10+4.0, ([0, 54], [1, 61], [1.25, 71])],\n" +
    "\t[+7-4+2.0, ([0, 54], [1, 61], [1.5, 57])],\n" +
    "\t[+7-2+2.0, ([0, 54], [1, 61], [1.5, 59])],\n" +
    "\t...\n" +
    "\t[-5-5+1.0, ([4, 68], [5, 63], [6, 58])],\n" +
    "\t[-5-2+1.0, ([4, 68], [5, 63], [6, 61])],\n" +
    "\t[-5+7+1.0, ([4, 68], [5, 63], [6, 70])]\n" +
    "]"
let p1999_entries = "[\n" +
    "\t[-12+2+2.0, ([0, 69], [0.5, 57], [0.75, 59])],\n" +
    "\t[-12+3+1.0, ([0, 69], [0.5, 57], [1, 60])],\n" +
    "\t[-12+5-1.5, ([0, 69], [0.5, 57], [1.25, 62])],\n" +
    "\t...\n" +
    "\t[-5-7+1.0, ([4, 74], [5, 69], [6, 62])],\n" +
    "\t[-5-5+1.0, ([4, 74], [5, 69], [6, 64])],\n" +
    "\t[-5-2+1.0, ([4, 74], [5, 69], [6, 67])]\n" +
    "]"
