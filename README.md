...
This repo contains supplementary code for AIMGEF, which currently covers the published conference paper:
```
...
```
Please find the following procedures for reproducing the results stated in the paper:
